package com.feidian.framework.web.exception;
...
import com.feidian.common.exception.DemoModeException;
...
public class GlobalExceptionHandler
{
    ...
    public AjaxResult handleNullPointerException(NullPointerException e,HttpServletRequest request)
    {
        ...
        String result = getResult(e);
        //定位到异常具体位置后，返回对应的错误信息
        switch (result){
            case "com.feidian.sidebarTree.service.impl.TreePictureServiceImpl.deleteTreePictureByPictureId":{
    ...
    private String getResult(Exception e){
